    ...
    >
      <motion.div className="text" variants={variants}>
        ...
        <motion.div className="mail">
          ...
          <motion.span>mustafamasoud95@gmail.com</motion.span>
        </motion.div>
        <motion.div className="phone">
          <motion.h4>phone</motion.h4>
          <motion.span>(+20) 1010254072</motion.span>
        </motion.div>
        <motion.div className="address">
          <motion.h4>address</motion.h4>
          <motion.span>Cairo/Egypt</motion.span>
        </motion.div>
      </motion.div>
      <motion.div
      ...
      >
        ...
        >
          ...
          <p>{error && alert("Error")}</p>
          <p>{sucess && alert("sent")}</p>
        </motion.form>
      </motion.div>
    </motion.div>
  );
